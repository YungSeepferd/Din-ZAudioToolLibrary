 ...
 *
 * Provides Model Context Protocol access to Web Audio API documentation
 * and code examples through Claude Code.
 *
 * Features:
 * - Search Web Audio documentation
 * - Get API reference for specific nodes
 * - Fetch code examples
 * - Browse audio graph patterns
 ...
 *
 * Then in Claude Code:
 * @web-audio search for delay node API
 * @web-audio show audiocontext example
 * @web-audio explain scheduling
 */
...
// Simple console output system (since we don't have MCP SDK in this environment)
...
if (require.main === module) {
  ...
  if (query) {
    ...
    console.log('Usage: node web-audio-mcp.js "search query"');
  }
}
